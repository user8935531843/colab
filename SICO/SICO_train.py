import datetime
print(f"--- [{datetime.datetime.now()}] SICO_train.py execution started ---", flush=True)
import argparse
import os
...
if __name__ == '__main__':
    ...
    print(f"--- [{datetime.datetime.now()}] Entered __main__ block ---", flush=True)


    parser.add_argument('--dataset', type=str, default='squad',
                        choices=['squad', 'yelp', 'eli5', 'test', 'hc3_wiki'])
